...
class UserController {
    ...
    static userData(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                var users = yield User_1.default.findById({ _id: userId }, { __v: 0 }).populate(new Populate_1.Populate().userPopulate);
                const data = {
                    message: 'Success',
                    data: users
                };
    ...
    static all(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const category = yield User_1.default.find().populate(new Populate_1.Populate().userPopulate);
                const data = {
                    message: 'Success',
                    data: category
                };
    ...
    static profile(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const user = yield User_1.default.findOneAndUpdate({ _id: userId }, update, { new: true, useFindAndModify: false }).populate(new Populate_1.Populate().userPopulate);
                res.json({
