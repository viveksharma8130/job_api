...
class GlobalMiddleWare {
    ...
    static employerAuthenticate(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const authHeader = req.headers.authorization;
            const token = authHeader ? authHeader.slice(7, authHeader.length) : null;
            try {
                Jwt.verify(token, env_1.getEnvironmentVariables().jwt_secret, ((err, decoded) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    else if (!decoded.employer_id) {
                        req.errorStatus = 401;
                        next(new Error('Employer Not Authorised'));
                    }
                    else {
    ...
    static recruiterAuthenticate(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const authHeader = req.headers.authorization;
            const token = authHeader ? authHeader.slice(7, authHeader.length) : null;
            try {
                Jwt.verify(token, env_1.getEnvironmentVariables().jwt_secret, ((err, decoded) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    else if (!decoded.recruiter_id) {
                        req.errorStatus = 401;
                        next(new Error('recruiter Not Authorised'));
                    }
                    else {
